...
namespace restapi.Models
{
    public class Timecard
    {
        ...
        public DocumentLine BuildDocumentLine(TimecardLine line) {
            DocumentLine docLine = new DocumentLine();
            docLine.Day = line.Day;
            docLine.Week = line.Week;
            docLine.Hours = line.Hours;
            docLine.Year = line.Year;
            docLine.Project = line.Project;
        ...
        public void CheckAndRemoveExistingLine(DocumentLine inputDocumentLine){
            foreach(TimecardLine line in Lines){
                ...
                if(string.Equals(docLine.ToString(), inputDocumentLine.ToString() ,StringComparison.OrdinalIgnoreCase)) {
                    Lines.Remove(line);
                    break;
                }
            }
